...
| Website chat | Built in; **no outside service** | A chat button on every public page. Patients choose English or Tagalog. It answers from the website's own content (services, branches, hours, phone numbers, how to book), never quotes prices or gives medical advice, and steers every answer toward booking: the booking link is pre-filled with the branch and treatment they asked about. "Have our team call me" saves an inquiry under **Leads** (source *Website chat*). The conversation itself is never stored. | Nothing. Wording lives in `app/static/js/chat.js`. |
